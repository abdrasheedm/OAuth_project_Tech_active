...
SECRET_KEY = 'django-insecure-m@(p)2)5_d%c6%wet+!w!=vys*ez%pjse-9w#lu-w)2fes647z'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        ...
        'user': '5/minute',  # Rate limit for authenticated users
    },
...
OAUTH2_PROVIDER = {
    'ACCESS_TOKEN_EXPIRE_SECONDS': 3 * 60,
